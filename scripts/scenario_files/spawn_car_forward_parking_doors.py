...
class CarForwardParkingWithDoors():
    """
    ...
    def tick(self, ego_vehicle, traffic_manager=None):
        ...
        and shuts off the vehicle. The scenario waits for the ego vehicle to arrive and then
        opens the driver's side door (front left).
        ...
        if self.triggered:
            ...
            if self.checkpoint[0] == False:
                ...
                if self.timer > 50 and ego_vehicle.get_transform().location.x > (99.50+get_vehicle_speed(ego_vehicle)):
                    self.timer -= 1
                else:
    ...
    def trigger(self):
        ...
        self.triggered = True
        print('Scenario -Car forward parking and opens doors- has been triggered!')
    ...
    def destroy(self, client):
        ...
        print('\nScenario -Car forward parking and opens doors- finished!')
    ...
    try:
        ...
        try:
            while True:
                ...
                if Scenario is None:
                    Scenario = CarForwardParkingWithDoors(world, ego_vehicle_actor)
                else:
                    if scenario_timer > 0:
