...
# with a "STOP" traffic sign on his shirt or jacket seen from the back
...
class PedestrianAdvesarialBack():
    ...
    def __init__(self, world, ego_vehicle=None, trigger_points=None):
        ...
        bp_pedestrian = blueprint_library.find('walker.pedestrian.0002')
    ...
    def trigger(self):
        ...
        """
        self.pedestrian_actor.apply_control(carla.WalkerControl(direction=carla.Vector3D(x=-1.0, y=-0.02, z=0.1), speed=2.3, jump=False))
        self.triggered = True
