...
# Original scenario file edited to deterministically spawn a vehicle with a guitarcase item on its roof
...
class CarWithItem():
    ...
    def __init__(self, world, ego_vehicle=None, trigger_points=None):
        ...
        random_key = 'static.prop.guitarcase'
    ...
    def trigger(self):
        ...
        """
        self.triggered = True
        print('Scenario -Car Dropping an Item Guitarcase- has been triggered!')
    ...
    def destroy(self, client):
        ...
        """
        print('\nScenario -Car Dropping an Item Guitarcase- finished!')
