...
# Original scenario file edited to deterministically spawn a vehicle that will realize its mistake and turn left as soon as possible
...
class CarInOppositeDirection():
    ...
    def __init__(self, world, ego_vehicle=None, trigger_points=None):
        ...
        self.random_choice = False # False for scenario vehicle to avoid running into one-way street
        self.timer = 100
        self.actor_list = []
...
def main():
    ...
    try:
        ...
        # Spawn ego vehicle
        ego_vehicle_actor = world.spawn_actor(bp_ego_vehicle, carla.Transform(carla.Location(x=-88.40, y=-17.80, z=0.6), carla.Rotation(pitch=0, roll=0, yaw=90)))
