...
# Original scenario file edited to deterministically spawn a vehicle with a travelcase item on its roof
...
class CarWithItem():
    ...
    def __init__(self, world, ego_vehicle=None, trigger_points=None):
        ...
        random_key = 'static.prop.travelcase'
    ...
    def trigger(self):
        ...
        """
        self.triggered = True
        print('Scenario -Car Dropping an Item Travelcase- has been triggered!')
    ...
    def destroy(self, client):
        ...
        """
        print('\nScenario -Car Dropping an Item Travelcase- finished!')
